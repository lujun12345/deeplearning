...
from src.trainer.trainer_xsleepnet import Trainer
...
if __name__ == '__main__' :
    file_path = r'E:\python\deep-sleep\src\configs\shuju4_xsleep_exp.yaml'


    parser = argparse.ArgumentParser(description='DeepSleep')
    parser.add_argument('-c', '--config', default=file_path, type=str,
    ...
    # DEBUGGING:
    args.config = 'E:\python\deep-sleep\src\configs\shuju4_xsleep_exp.yaml'
