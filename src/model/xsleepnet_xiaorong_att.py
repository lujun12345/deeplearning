...
class XSleepNet(nn.Module):
    ...
    def _seq_sleepnet_forward(self, x2):
        ...
        attention_out = torch.mean(seq_frame_rnn_out, dim=1)  # [batch*epoch_seq_len, 2*seq_nhidden1]
    ...
    def forward(self, x):
        ...
        for i in range(self.epoch_seq_len):
            ...
            fused_score = w1_norm * deep_scores[i] + w2_norm * seq_scores[i] + w3_norm * joint_scores[i]
    ...
    def compute_loss(self, outputs, y):
        ...
        output_loss = w1_norm * deep_loss + w2_norm * seq_loss + w3_norm * joint_loss
