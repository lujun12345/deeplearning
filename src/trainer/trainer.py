...
from src.utils.adjust_learning_rate import adjust_learning_rate_by_weights as adl
...
class Trainer(BaseTrainer):
    ...
    def _train_epoch(self, epoch):
        ...
        total_metrics += self._eval_metrics(all_preds, all_targets)
    ...
    def _valid_epoch(self, epoch):
        ...
        total_val_metrics += self._eval_metrics(all_val_preds, all_val_targets)
